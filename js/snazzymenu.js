    ...
    $.fn.snazzyMenu = function (options, breakpoint) {
        ...
        return this.each(function () {
            ...
            nav.find('.menu').before(
                '<div class="controls"><div class="logo"><a href="https://form.jotform.com/220449112663148" title="Enter Today! (Opens in a new tab)" target="_blank">' +
                    homeBtn +
                    '</a></div><div class="cta"><button class="menu-toggle">MENU</button></div></div>'
            );
